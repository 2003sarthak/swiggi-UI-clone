...
export default function FooterTop() {
  ...
  return (
    <>
      <div className="w-full h-[104px] bg-[#f0f0f5] flex items-center justify-evenly mt-4">
        <div className="text-[20px] sm:text-[16px] xl:font-bold xl:text-[25px] text-[#02060CBF]">
          For better experience, download the Swiggy app now
        </div>
        <div className="hidden sm:block xl:cursor-pointer">
          <img
      ...
      <div className="text-[20px] flex flex-col md:w-full h-auto bg-[#02060C] justify-evenly pt-10 md:text-base sm:flex-row">
        <div className="flex flex-col items-start">
          <div className="flex items-center justify-center ">
            ...
            <div className="text-[#FFFFFFEB] font-bold text-xl m-3">Swiggi</div>
          </div>
        ...
        <div className="flex flex-col items-start">
          <div className="text-[#FFFFFFEB] font-bold text-xl">Company</div>
          <ul>
            {companyData.map((com, index) => {
              return (
                <li
                  className="text-[#FFFFFF99] cursor-pointer my-2"
                  key={index}
                >
                  {com.title}
                </li>
        ...
        <div className="flex flex-col items-start">
          <div className="text-[#FFFFFFEB] font-bold text-xl">Contact Us</div>
          <ul>
            {ContactUsData.map((com, index) => {
              return (
                <li
                  className="text-[#FFFFFF99] cursor-pointer my-2"
                  key={index}
          ...
          <div className="text-[#FFFFFFEB] font-bold text-xl">Legal</div>
          <ul>
            {legalData.map((com, index) => {
              return (
                <li
                  className="text-[#FFFFFF99] cursor-pointer my-2"
                  key={index}
        ...
        <div className="flex flex-col items-start">
          <div className="text-[#FFFFFFEB] font-bold text-xl">
            We Deliver To
          </div>
          <ul>
            {DeliverToData.map((com, index) => {
              return (
                <li
                  className="text-[#FFFFFF99] cursor-pointer my-2"
                  key={index}
          ...
          <div className="text-[#FFFFFF99] cursor-pointer border border-solid border-[#FFFFFF99] rounded-md">
            589 cities
            <IoIosArrowDown
              className={`inline cursor-pointer transition-transform duration-300 ${
